...
flex justify-center items-center text-xl'>
    ...
    items-center mb-4 text-primary w-full'>View Cart</Link>
        <Link className='bg-primary text-white flex p-4 justify-center
    items-center text-primary w-full'>Checkout</Link>
